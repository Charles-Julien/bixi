...
a reduced model. The reduced model in this case contains only the
holiday and weekend indicator whereas the full model also includes
membership in addition to the two variables. The goal here is to
determine if the addition of membership significantly improves the
...
want to determine if the addition of membership improves the likelihood
...
-   **Intercept**: The intercept ($\beta = 2.581791$) represents the log
    ...
    zero. The IRR for the intercept cannot be interpreted in the same
    way because it relates to the situation where all predictor
...
-   The observed reduction in trips during the spring and summer, when
    ...
    enhance ridership in these seasons. \## Anova test
