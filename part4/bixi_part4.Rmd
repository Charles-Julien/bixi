...
df_raw = read.csv(file.path(root,'src',"bixi10.csv"))
df_station = read.csv(file.path(root,'src',"2021_stations.csv"))
```
...
```{r}
getVarCov(seasonal_effect_rev.ar, type = "random.effects")
```
...
```
The Model estimates are similar despite correlation structure.
```{r}
...
31b8e172-b470-440e-83d8-e6b185028602::31b8e172-b470-440e-83d8-e6b185028602
```
