...
```{r seasonal effect on trip duration echo=FALSE}
...
```{r Seasonal effect on revenue echo=FALSE}
...
```{r Time pattern on revenue echo=FALSE}
...
```{r Time pattern on trip duration echo=FALSE}
